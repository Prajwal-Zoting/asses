...
const link = 'mongodb+srv://Siddhant:12345@cluster0.pjmivn7.mongodb.net/?retryWrites=true&w=majority'
mongoose
  .connect(link)
  .then(function (db) {
...
app.post('/deleteStudent',(req,res)=>{
    ...
    student.deleteOne({"Roll_No":id}).then(()=>{
...
app.post('/updateStudent',(req,res)=>{
  let id=req.body.Roll_No;  // roll no of 

  var stud=new student(req.body);

  student.deleteOne({"Roll_No":id}).then(()=>{///delete element 
    
    console.log("Deleted");
        stud.save().then(()=>{      ///add new element
